...
@implementation CustomLocationAnnotation
...
{
    if(!locationView) {
        locationView = (CustomLocationView*)[aMapView dequeueReusableAnnotationViewWithIdentifier:@"CustomLocationView"];
        if(!locationView)
            locationView = [[CustomLocationView alloc] initWithAnnotation:self andRecord:record];
    } else {
